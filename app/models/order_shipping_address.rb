class OrderShippingAddress
  ...
  with_options presence: true do 
    ...
    validates :postal_code, format: {with: /\A[0-9]{3}-[0-9]{4}\z/, message: "is invalid. Include hyphen(-) & half-width numbers(e.g. 000-0000)"}
    validates :phone_number, numericality: { message: "is invalid. Input only half-width numbers" }
  end
